...
.. csv-table::
   ...
   fq_name " route-table" Type "Requ " CRU " Default " Valid " ABCDE
   uuid " route-table" Type "Requ " CRU " Default " Valid " ABCDE
   parent_uuid " route-table" Type "Requ " CRU " Default " Valid " ABCDE
   parent_href " route-table" Type "Requ " CRU " Default " Valid " ABCDE
   parent_type " route-table" Type "Requ " CRU " Default " Valid " ABCDE
   href " route-table" Type "Requ " CRU " Default " Valid " ABCDE
   id_perms " route-table" Type "Requ " CRU " Default " Valid " ABCDE
   ...
   name " route-table" Type "Requ " CRU " Default " Valid " ABCDE
route-tables JSON
====
