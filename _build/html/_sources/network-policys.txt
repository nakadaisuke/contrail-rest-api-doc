...
====================
 ...
 network-policy includes policy actions, virtual network and so on
...
.. csv-table::
   ...
   simple_action " action_list " string " No " CRU " N/A " Valid form {alert|drop|deny|log|pass|reject} " The simple action type
