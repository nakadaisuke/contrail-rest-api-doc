...
.. csv-table::
   ...
   fq_name " network-policy" Type "Requ " CRU " Default " Valid " ABCDE
   uuid " network-policy" Type "Requ " CRU " Default " Valid " ABCDE
   parent_uuid " network-policy" Type "Requ " CRU " Default " Valid " ABCDE
   parent_href " network-policy" Type "Requ " CRU " Default " Valid " ABCDE
   parent_type " network-policy" Type "Requ " CRU " Default " Valid " ABCDE
   href " network-policy" Type "Requ " CRU " Default " Valid " ABCDE
   id_perms " network-policy" Type "Requ " CRU " Default " Valid " ABCDE
   ...
   name " network-policy" Type "Requ " CRU " Default " Valid " ABCDE
