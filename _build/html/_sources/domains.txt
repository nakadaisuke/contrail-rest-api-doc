...
====================
 ...
 domain defines which attribute associated with.
...
.. csv-table::
   ...
   fq_name " domain" list(str) "Yes " CR " N/A " Valid full query name form <domain>" The full query name of this attribute
