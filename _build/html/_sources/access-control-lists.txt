...
====================
 ...
 access-control-list includes ACL attributes 
...
.. csv-table::
   ...
   simple_action " action_list " String " No " CRU " pass " Valid form {alert|drop|deny|log|pass|reject} " Specifies action for the packet
   ...
   network_policy " dst_address " string " No " CRU " null " Valid form {sequence|timer} " The network policy time
   ...
   protocol " match_condition " string " No " CRU " any " Valid form {tcp|udp|icmp|any} " The protocol name
   src_address " match_condition " string " No " CRU " null " Valid IP address " The source address for ACL
   network_policy " src_address " string " No " CRU " null " Valid form {sequence|timer} " The network policy time
   ...
   dynamic " access_control_list_entries " bool " No " CRUD " null " Valid form {true|false} " Specifies whether access list is dynamic or not.
   display_name " access-control-list " string " No " CR " generated " N/A " Display name
   fq_name " access-control-list " list(str) " Yes " CR " [] " Valid from <domain>,<tenant>,<name> " The full query name of this attribute
