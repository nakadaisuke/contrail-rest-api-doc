...
.. csv-table::
   ...
   family " address_families" list(str) "No " CRUD " null "{inet-vpn|inet6-vpn|route-target|e-vpn|erm-vpn} " Set BGP address families  
   ...
   family " address_families" list(str) "No " CRUD " [] "{inet-vpn|inet6-vpn|route-target|e-vpn|erm-vpn} " Set BGP address families
