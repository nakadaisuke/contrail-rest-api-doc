...
.. csv-table::
   ...
   encapsulation " encapsulation_priorities " list(str) " Yes " CRUD " [] " Valid form {VXLAN|MPLSoUDP|MPLSoGRE} " The encapsulation protocol type
   ...
   vxlan_network_identifier_mode " global-vrouter-config " string " Yes " CRU " N/A " Valid form {configured|automatic} " The VXLAN network identifier mode
