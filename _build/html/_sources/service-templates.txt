...
====================
 ...
 service-template includes interface,image,AZ and so on
...
.. csv-table::
   ...
   availability_zone_enable " service_template_properties " bool " No " CRU " false " Valid form {true|false} " Specifies whehter the availability zone is enable or not
   ...
   service_interface_type " interface_type " string " No " CRU " null " Valid form {management|left|right|other} " The interface type
   static_route_enable " interface_type " bool " No " CRU " false " Valid form {true|false} " Specifies whehter the static route is enable or not
   shared_ip " interface_type " bool " No " CRU " false " Valid form {true|false} " Specifies whehter the shared IP is enable or not
   ordered_interfaces " service_template_properties " bool " No " CRU " false " Valid form {true|false} " Specifies whehter the orderd interface is enable or not
   service_mode " service_template_properties " string " No " CRU " null " Valid form {transparent|in-network|in-network-nat} " The service mode type
   service_scaling " bool " No " CRU " false " Valid form {true|false} " Specifies whehter the service scaling is enable or not
   service_type " service_template_properties " string " No " CRU " null " Valid form {firewall|analyzer|source-nat|loadbalancer} " The service mode type
