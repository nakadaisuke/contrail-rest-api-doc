...
.. csv-table::
   ...
   ipam_dns_method " network_ipam_mgmt " string " Yes " CRU " N/A " Valid form {none|default-dns-server|tenant-dns-serer|virtual-dns-server} " The IPAM DNS method
   ...
   addr_from_start " ipam_subnets " bool " Yes " CRU " N/A " Valid form {true|false} " Specifies whether the address allocation method is start or end
   ...
   enable_dhcp " ipam_subnets " bool " Yes " CRU " N/A " Valid form {true|false} " Specifies whether the DHCP enable or disable
